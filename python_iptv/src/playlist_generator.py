...
BOUQUETS = {
    ...
    "Intrattenimento": ["SKY UNO", "SKY ARTE", "SKY SERIE", "SKY ATLANTIC", "COMEDY CENTRAL", "PREMIUM ACTION", "PREMIUM CRIME", "PREMIUM STORIES", "FOX", "BLAZE", "GIALLO", "LAEFFE", "TV2000", "NOVE", "REAL TIME", "DMAX", "MEDIASET EXTRA", "DONNATV", "FASHION TV"],
    ...
    "Sport": ["SKY SPORT", "DAZN", "EUROSPORT", "TENNIS", "MOTOGP", "F1", "CALCIO", "ACISPORT", "LIVECAMP", "ELEVEN", "DIRT", "GOLF", 
              ...
              "ACI SPORT", "BIKE", "MOTOR TREND", "NBA", "NFL", "WWE", "FIGHT", "UFC", "EQUTV", "HORSE TV"],
    ...
    "Documentary": ["SKY DOCUMENTARIES", "SKY NATURE", "GEO", "DISCOVERY", "HISTORY",
                     ...
                     "ANIMAL PLANET", "PESCA", "CACCIA", "MARCOPOLO", "FOCUS", "SCIENCE", "EXPLORER HD"],
